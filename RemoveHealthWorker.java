 ...
 * @author ajayj
 */
public class RemoveHealthWorker extends javax.swing.JFrame {

    /**
     * Creates new form FAQ
     */
    public RemoveHealthWorker() {
        initComponents();
    ...
    private void initComponents() {
        ...
        t_healthWorkers = new javax.swing.JTable();
        jSeparator1 = new javax.swing.JSeparator();
        l_wokerID = new javax.swing.JLabel();
        tf_wokerID = new javax.swing.JTextField();
        ...
        l_title.setText("Remove Health Worker");
        ...
        l_regHealthWorkers.setText("Registered Health Workers");

        t_healthWorkers.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        t_healthWorkers.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                t_healthWorkersMouseClicked(evt);
            }
        });
        sp_healthWorkers.setViewportView(t_healthWorkers);

        l_wokerID.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        l_wokerID.setText("Selected Health Worker ID");

        tf_wokerID.setEditable(false);

        tf_wokerName.setEditable(false);

        l_wokerName.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        l_wokerName.setText("Name of Health Worker");
        ...
        jLabel2.setText("Select the row of  Health Worker to be removed");
                    ...
                    .addGroup(p_mainLayout.createSequentialGroup()
                        ...
                        .addGroup(p_mainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, p_mainLayout.createSequentialGroup()
                                ...
                                .addGap(166, 166, 166)
                                .addComponent(tf_wokerID, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(p_mainLayout.createSequentialGroup()
                        .addGap(384, 384, 384)
        ...
        p_mainLayout.setVerticalGroup(
            ...
            .addGroup(p_mainLayout.createSequentialGroup()
                ...
                .addGroup(p_mainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(l_wokerID)
                    .addComponent(tf_wokerID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(40, 40, 40)
                .addGroup(p_mainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(l_wokerName)
    ...
    private void cb_RlocalbodyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_RlocalbodyActionPerformed
        ...
        try{
            Connection con = new Connector().getCon();
            PreparedStatement ps = con.prepareStatement("SELECT hw.hw_id,citi.c_fullname, citi.c_phno, hw.highest_qualification, hw.institution_name, hw.designation FROM `asdproject`.`healthworker_list` hw, `asdproject`.`citizen_list` citi, `asdproject`.`panchayaths` panch  WHERE citi.c_id=hw.citizen_id AND citi.c_local_body_name_id=panch.p_id AND panch.p_name=?");
            ps.setString(1, body);  
            ResultSet rs = ps.executeQuery();
            t_healthWorkers.setModel(DbUtils.resultSetToTableModel(rs));
            if(!rs.first())
            JOptionPane.showMessageDialog(null,"No Health Workers Registered in "+cb_Rlocalbody.getSelectedItem().toString());
        } catch(Exception e){
            //e.printStackTrace();
    ...
    private void t_healthWorkersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_t_healthWorkersMouseClicked
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) t_healthWorkers.getModel();
        
        int RowIndex = t_healthWorkers.getSelectedRow();
        tf_wokerID.setText(t_healthWorkers.getModel().getValueAt(RowIndex, 0).toString());
        tf_wokerName.setText(t_healthWorkers.getModel().getValueAt(RowIndex, 1).toString());
         
    }//GEN-LAST:event_t_healthWorkersMouseClicked
    ...
    private void b_removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_removeActionPerformed
        ...
        int RowIndex = t_healthWorkers.getSelectedRow();
        String id = t_healthWorkers.getModel().getValueAt(RowIndex, 0).toString();
        try{
            Connection con = new Connector().getCon();
            PreparedStatement ps = con.prepareStatement("DELETE FROM asdproject.healthworker_list WHERE hw_id=?");
            ps.setString(1, id);
            ...
            if(rs!=0)
            {
                 JOptionPane.showMessageDialog(null,"Health worker Removed Sucessfully");
                 cb_Rlocalbodytype.setEnabled(false);
                 cb_Rlocalbody.setEnabled(false);
            }
            else
               JOptionPane.showMessageDialog(null,"Health Worker Not Removed","Error",JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveHealthWorker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable t_healthWorkers;
    private javax.swing.JTextField tf_wokerID;
